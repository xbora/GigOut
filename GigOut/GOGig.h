...
@interface GOGig : NSObject {
    ...
    NSString *artistLargeImgUrl;
    NSString *artistSmallImgUrl;
    NSString *venueId_;
    NSString *venueName_;
    NSString *venueLat_;
    NSString *venueLng_;
...
@property (nonatomic, copy) NSString *artistLargeImgUrl;
@property (nonatomic, copy) NSString *artistSmallImgUrl;

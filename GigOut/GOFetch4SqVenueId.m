...
-(void) retrieve4SqVenueId
{
    ...
    if (dictionary != nil) {
        ...
        NSDictionary *venueResponse = [dictionary objectForKey:@"response"];
        NSArray *venueGroups = [venue_groups objectAtIndex:0];
        NSArray *venues = [venue_groups objectAtIndex:0];
        if (venues != nil) {
